...
public class LocationAdapter extends ArrayAdapter<Location> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView titleTextView = listItemView.findViewById(R.id.location_title_text_view);
        ...
        TextView descriptionTextView = listItemView.findViewById(R.id.location_description_text_view);
        // Get the title for the current Location object and set it to the Title TextView
        ...
        final TextView addressTextView = listItemView.findViewById(R.id.location_address_text_view);
        TextView phoneNumberTextView = listItemView.findViewById(R.id.location_phone_number_text_view);
        TextView openingHoursTextView = listItemView.findViewById(R.id.location_opening_hours_text_view);
        ImageView pictureImageView = listItemView.findViewById(R.id.location_picture_image_view);
